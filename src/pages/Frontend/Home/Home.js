        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <p className="lead">
                The best platform to create and manage your online courses
                effortlessly.
              </p>
              <Link to="/dashboard" className="btn btn-light btn-lg my-3">
                Get Started
              </Link>
            </div>
            <div className="col-md-6">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-4 text-center">
              <img
                src="https://www.logintc.com/wp-content/uploads/banner.png"
            ...
            <div className="col-md-4 text-center">
              <img
                src="https://atlas-content-cdn.pixelsquid.com/stock-images/stack-of-books-book-xwVGJW9-600.jpg"
            ...
            <div className="col-md-4 text-center">
              <img
                src="https://static.vecteezy.com/system/resources/previews/020/954/779/non_2x/business-chart-with-arrow-free-png.png"
      ...
      <section className="services bg-light py-5" id="services">
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-4 text-center">
              <img
                src="https://cdn-icons-png.flaticon.com/512/4423/4423859.png"
                alt="Course Creation"
                className="img-fluid mb-3"
              />
            ...
            <div className="col-md-4 text-center">
              <img
                src="https://cdn-icons-png.flaticon.com/512/3407/3407038.png"
                alt="Quizzes and Assessments"
                className="img-fluid mb-3"
              />
      ...
      <section className="advantages py-5">
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-3 text-center">
              <img
                src="https://cdn-icons-png.flaticon.com/512/4660/4660672.png"
                alt="Accessibility"
                className="img-fluid mb-3"
              />
              <h4>Accessibility</h4>
            ...
            <div className="col-md-3 text-center">
              <img
                src="https://cdn-icons-png.flaticon.com/512/6091/6091742.png"
                alt="Scalability"
                className="img-fluid mb-3"
              />
              <h4>Scalability</h4>
